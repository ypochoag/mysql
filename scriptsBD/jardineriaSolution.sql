...
FROM pedido
WHERE (fecha_entrega) < (SELECT ADDDATE(fecha_esperada, INTERVAL -2 DAY));

-- o Utilizando la función DATEDIFF de MySQL.
SELECT codigo_pedido, codigo_cliente, fecha_esperada, fecha_entrega
FROM pedido
WHERE 2 < (SELECT DATEDIFF(fecha_esperada, fecha_entrega));
...
SELECT o.linea_direccion1, c.ciudad
FROM oficina o
INNER JOIN empleado e
